    ...
    <View style={styles.footer}>
      <View style={styles.footerRow}>
        ...
        <View style={styles.leftSection}>
          <Text style={styles.copyrightText}>©Pasifika Hub — All rights reserved</Text>
        </View>

        {/* Center: Social Media */}
        <View style={styles.centerSection}>
          <TouchableOpacity onPress={() => handleSocialPress('https://snapchat.com')}>
          ...
          <TouchableOpacity onPress={() => handleSocialPress('https://tiktok.com')}>
